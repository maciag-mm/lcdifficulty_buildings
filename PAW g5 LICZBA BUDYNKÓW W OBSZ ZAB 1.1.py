...
Name : PAW g5 LICZBA BUDYNKÓW W OBSZ ZAB 1.1
Group : 
With QGIS : 34000
"""
...
class PawG5LiczbaBudynkwWObszZab11(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFeatureSink('G5', 'g5', type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, supportsAppend=True, defaultValue=None))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        outputs['LiczObszaryZabudowy'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        alg_params = {
            'INPUT': outputs['LiczObszaryZabudowy']['OUTPUT'],
            'OUTPUT': QgsProcessing.TEMPORARY_OUTPUT
        }
        ...
        alg_params = {
            ...
            'FORMULA': '\r\nattribute(get_feature( @Agreguj_budynki_OUTPUT,\'layer\',replace("layer",\'OBSZ_ZABUD\',\'BUD\')),\'L_BUD\')',
            'INPUT': outputs['AgregujObszary']['OUTPUT'],
            'OUTPUT': parameters['G5']
        }
        outputs['G5'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['G5'] = outputs['G5']['OUTPUT']
        return results

    def name(self):
        return 'PAW g5 LICZBA BUDYNKÓW W OBSZ ZAB 1.1'
    ...
    def createInstance(self):
        return PawG5LiczbaBudynkwWObszZab11()
