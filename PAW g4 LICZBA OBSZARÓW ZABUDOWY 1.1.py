...
Name : PAW g4 LICZBA OBSZARÓW ZABUDOWY 1.1
Group : 
With QGIS : 34000
"""
...
class PawG4LiczbaObszarwZabudowy11(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFeatureSink('G4', 'g4', type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, defaultValue='TEMPORARY_OUTPUT'))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        outputs['G4'] = processing.run('native:fieldcalculator', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
    ...
    def createInstance(self):
        return PawG4LiczbaObszarwZabudowy11()
